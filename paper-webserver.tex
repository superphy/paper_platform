...
% 1. brief: WGS is standard
Whole genome sequencing (WGS) uses the entire genetic content of an organism, and is used for bacterial surveillance \cite{ronholm2016navigating,lytsy2017time}, research into disease \cite{wang2014whole,yuen2015whole}, and clinical diagnoses \cite{willig2015whole,dewey2014clinical}.
% 2. Big Problem: but tools are for individual analysis
