...
Furthermore, many studies \cite{todd1989costs,scharff2010health} document the associated economic costs.
% surveillance
...
In \textit{Salmonella enterica} \cite{bell2016recent}, \textit{Escherichia coli} \cite{fratamico2016advances}, and others pathogens \cite{ronholm2016navigating}, surveillance now involves a variety of bioinformatic approaches based on whole-genome sequencing (WGS).
