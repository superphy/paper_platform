...
While we prefer to package individual bioinformatics programs using language-agnostic package managers such as Conda \url{https://conda.io/}, we do agree that suites of bioinformatics software benefits from having all dependencies installed and deployable in Docker containers \cite{di2015impact}.
