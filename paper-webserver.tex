...
% surveillance
Public-health agencies routinely look for emerging threats, of which \textit{Salmonella enterica} and \textit{Escherichia coli} are amongst the two most common \cite{kozak2013foodborne}.
...
To begin analyzing genomes, researchers designate particular strains of bacterial isolates by identifiers known as subtypes.
...
In public health agencies, PFGE is used to track outbreaks by comparing band patterns of bacterial isolates \cite{kozak2013foodborne}. 
The original computational methods leveraging WGS returned subtyping results matching those of wet-lab techniques.
