...
To scale Superphy for tens of thousands of genomes and for use by front-line clinicians, software pipelines should run in real-time and existing population-wide analyses should automatically integrate new results.
