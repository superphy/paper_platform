...
Graph databases focus on describing the relationships between different data points, and is one of the emerging \cite{de2015trends} database types used for biological data.
Spfy 
