...
% para
% goals: predictive analylitcs in minutes, storage up 50,000-100,000 genomes 
...
% ex. in python, tox can be set to spin up docker containers for testing - see certbot
% could spin up a new container for each analysis module to run see \cite{di2015impact} - neglible performance impact
