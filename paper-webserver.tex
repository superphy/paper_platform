...
BAP and IRIDA help address "big-data" challenges by offering a hosted solution which computes results in real-time, and parallelizing analyses across computing resources.
