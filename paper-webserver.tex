...
On run-times of analogous algorithmns for prediction tasks, Spfy performs at a similar speed to BAP, though Spfy does not provide genome assembly services.
Spfy also uses a Python-based backend instead of PHP, and Spfy's use of Docker containerization and task queues is a novel as well.
