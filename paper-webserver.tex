...
Graph databases focus on describing the relationships between different data points, is one of the emerging \cite{de2015trends} database types used for biological data, and is one of the core building blocks of a semantic web stack \cite{horrocks2005semantic}.
