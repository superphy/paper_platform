...
No account creation is required to use the platform. A sharable token is automatically created for users upon opening the website, and is embedded into the website address. Users can share results by copying the URL, and files submitted from different computers using the same token will have the results visible to anyone with the same URL.
