...
We demonstrate the ability of graph data structures to manage the tens of thousands of whole-genome \textit{E. coli} sequences accumulated so far, and use graphs for further downstream processing.
