...
% We need to reference the Tables in the text and explain them. Right now, this table isn't that informative. Eg. what is the importance of the names? Is this a lot of data etc.? If all entries in a column are the same, the column can be removed.
\begin{table}[!hb]
\centering
\caption{Database statistics for the nodes, leaves, and associated entries in the graph database, Blazegraph. The database stores all results from every included analysis module and associated metadata. Numbers are representative for analysis of 10,243 assembled genomes.}
\label{Table 1.}
\resizebox{\textwidth}{!}{%
